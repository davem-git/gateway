...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FilterChainMatcher) DeepCopyInto(out *FilterChainMatcher) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FilterChainMatcher.
func (in *FilterChainMatcher) DeepCopy() *FilterChainMatcher {
	if in == nil {
		return nil
	}
	out := new(FilterChainMatcher)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TCPListener) DeepCopyInto(out *TCPListener) {
	*out = *in
	...
	if in.FilterChainMatchers != nil {
		in, out := &in.FilterChainMatchers, &out.FilterChainMatchers
		*out = make([]*FilterChainMatcher, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(FilterChainMatcher)
