...
func (in *TCPListener) DeepCopyInto(out *TCPListener) {
	*out = *in
	...
	if in.NetworkFilters != nil {
		in, out := &in.NetworkFilters, &out.NetworkFilters
		*out = make([]*NetworkFilter, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(NetworkFilter)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ZoneAwareRouting) DeepCopyInto(out *ZoneAwareRouting) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ZoneAwareRouting.
func (in *ZoneAwareRouting) DeepCopy() *ZoneAwareRouting {
	if in == nil {
		return nil
	}
	out := new(ZoneAwareRouting)
